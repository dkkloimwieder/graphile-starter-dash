...
*/
 ...
 grant
   ...
   update (title),
   delete
 on app_public.topics to :DATABASE_VISITOR;
 ...
 create table app_public.posts (
   ...
   body             text,
   topic            text not null references app_public.topics(title) on delete restrict,
 ...
 create policy manage_own on app_public.topics for all using( true);
